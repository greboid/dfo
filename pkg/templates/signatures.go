...
var Signatures = map[string]pipelines.PipelineSignature{
	...
	"base": {
		Name:        "base",
		Description: "Minimal Alpine-based runtime stage",
		Parameters: map[string]pipelines.ParamSpec{
			"packages": {Type: pipelines.TypeStringArray, Required: false},
			"user":     {Type: pipelines.TypeString, Required: false},
			"workdir":  {Type: pipelines.TypeString, Required: false},
		},
	},
	"baseroot": {
		Name:        "baseroot",
		Description: "Alpine-based runtime with rootfs user/group setup",
		Parameters: map[string]pipelines.ParamSpec{
			"packages": {Type: pipelines.TypeStringArray, Required: false},
			"user":     {Type: pipelines.TypeString, Required: false},
			"uid":      {Type: pipelines.TypeInt, Required: false},
			"group":    {Type: pipelines.TypeString, Required: false},
			"gid":      {Type: pipelines.TypeInt, Required: false},
			"workdir":  {Type: pipelines.TypeString, Required: false},
		},
	},
	"go-app": {
